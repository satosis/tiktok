...
class HashVideos extends StatefulWidget {
  @override
  _HashVideosState createState() => _HashVideosState();
}

class _HashVideosState extends State<HashVideos> {
  ...
  loadMore() async {
    ...
    try {
      String apiUrl = apiUrlRoot + "api/v1/hash-tag-videos";
      ...
      if (rs.statusCode == 200) {
        if (rs.data['status'] == 'success') {
          ...
          setState(() {
            ...
            List<dynamic> tempBannerData = rs.data['tagBanners'];
            bannerData = tempBannerData.map((e) => json.encode(e)).toList();
            ...
            child: Container(
              ...
              child: Column(
                children: <Widget>[
                              ...
                              child: TextField(
                                ...
                                decoration: new InputDecoration(
                                  ...
                                  suffixIcon: IconButton(
                                    ...
                                    icon: Icon(
                                      Icons.clear,
                                      color: (searchKeyword.length > 0) ? Colors.white54 : Colors.black,
                                      size: 16,
                                    ),
                                  ),
                                ),
                  ...
                  (bannerData.length > 0)
                      ? Container(
                          ...
                          child: CarouselSlider(
                            ...
                            items: bannerData.map((var value) {
                              return Builder(
                  ...
                  Padding(
                    padding:
                        const EdgeInsets.only(top: 13, bottom: 2, left: 10),
                    child: Align(
                      alignment: Alignment.topLeft,
                      child: Container(
                        child: Text(
                  ...
                  (videoModelList != null && videoModelList.data.length > 0)
                      ? Padding(
