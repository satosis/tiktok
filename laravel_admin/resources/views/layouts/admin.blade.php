...
<title>Leuke - Adminstrator</title>
	...
	<script type="text/javascript" src="{{ asset('files/jquery/js/jquery.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('files/jquery-ui/js/jquery-ui.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('files/popper.js/js/popper.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('files/bootstrap/js/bootstrap.min.js') }}"></script>
...
<!--     <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css"> -->
	...
	<script src="{{ asset('files/amchart/amcharts.js') }}"></script>
    <script src="{{ asset('files/amchart/serial.js') }}"></script>
    <script src="{{ asset('files/amchart/light.js') }}"></script>
	...
	<section class="no-pad"> 
		...
		<div class="container-fluid">
			<div class="row topbar">
				<div class="col-lg-2">
					<img src="{{ asset('storage/uploads/logos/'.MyFunctions::getLogo()) }}" alt=""  class="logo"/>					
				</div>
				<div class="col-lg-10">
					  	...
					  	<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li> <i class="fa fa-cog" aria-hidden="true"></i> 
									<a href="{{ url(config('app.admin_url').'/settings')}}" class="anchor" style="display: inline !important;background-color: white;" >
                                        Setting
									</a>
								</li>
