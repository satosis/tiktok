            ...
            <div class="row card-header borderless ">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <div class="row"> -->
                               <?php
                                if($action == 'edit'){?>
                                   <form class="form-horizontal" role="form" action="<?php echo e(url( config('app.admin_url') .'/sounds/'.$id)); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo e(method_field('PUT')); ?>

                                <?php }else {?>
                                    <form class="form-horizontal" role="form" action="<?php echo e(url( config('app.admin_url') .'/sounds')); ?>" method="post" enctype="multipart/form-data">
                                <?php }?>
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <?php
                                                    ...
                                                    <select class="form-control" name="cat_id[]" id="cat_id" multiple <?php echo e($readonly); ?>>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    ?>
                                                    <input type="file" class="form-control" name="sound_name[]" value="<?php echo $sound_name;?>" <?php echo e($readonly); ?> multiple>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    ?>
                                                    <input type="text" class="form-control" name="album" value="<?php echo $album;?>" <?php echo e($readonly); ?>>
                                                </div>
                                            </div> 
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    ?>
                                                    <input type="text" class="form-control" name="artist" value="<?php echo $artist;?>" <?php echo e($readonly); ?>>
                                                </div>
                                            </div> 
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    ?>
                                                    <input type="text" class="form-control" name="tags" value="<?php echo $tags;?>" <?php echo e($readonly); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Wamp64\www\leuke-app\resources\views/admin/sounds-create.blade.php ENDPATH**/ ?>