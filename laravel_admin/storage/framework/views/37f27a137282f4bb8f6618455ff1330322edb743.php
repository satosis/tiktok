        ...
        <div class="page-top">
            ...
            <div class="page-berdcrumb">
                <ul class="breadcrumb">
                    ...
                    <!-- <li class="breadcrumb-item">
                        <a href="#" class="active">Manage Categories</a>
                    </li> -->
                </ul>       
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hp\Downloads\leuke App Package\laravel_admin\resources\views/admin/categories.blade.php ENDPATH**/ ?>