        ...
        <div class="page-top">
            ...
            <div class="page-berdcrumb">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a class="active" href="<?php echo e(route('admin.candidates.index')); ?>">Users Management</a>
                    </li>
                    <!-- <li class="breadcrumb-item">
...
<script type="text/javascript">
    ...
    function process_form(){
        ...
        if(season!=''){
            ...
            $.ajax({
                url: "<?php echo e(url( env('ADMIN_PATH'). '/candidates/make_visible')); ?>",
                method: 'post',
                data:{
                    season:season,
                    cat_id:$('#user_id_hidden').val(),
                },
                success: function(data){
                    if(data.status == 'success'){
                        showSuccess('modal1_success',data.msg,'modal1');
                        window.location = '<?php echo $path;?>';
                    }else{
                        showError('modal1_error',data.error);
                    }
                    stop_loading();
                }
            });
        }else{
            showError('modal1_error','Please select season');
        }
    }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Wamp64\www\leuke-app\resources\views/admin/candidates.blade.php ENDPATH**/ ?>