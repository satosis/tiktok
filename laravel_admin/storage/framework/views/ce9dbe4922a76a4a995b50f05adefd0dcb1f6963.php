        ...
        <div class="page-top">
            ...
            <div class="page-berdcrumb">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('admin.reports.index')); ?>">Reports Management</a>
                    </li>
                    <!-- <li class="breadcrumb-item">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Wamp64\www\leuke-app\resources\views/admin/reports.blade.php ENDPATH**/ ?>