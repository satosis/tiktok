...
<section>
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-4 ">
				<a href="<?php echo e(route('admin.candidates.show',[1])); ?>">
					<div class="card revenue">                   				
						<div>
							<h6>Total Users</h6>
							<h2><?php echo e($total_active_candidates); ?></h2>
							<p>Active</p>
			...
			<div class="col-lg-4">
				<a href="<?php echo e(url('videos')); ?>">
					<div class="card orders">                   				
						<div>
							<h6>Total Videos</h6>
							<h2><?php echo e($total_active_videos); ?></h2>
								<p>Active</p>
                                    ...
                                    <td>                                                      
                                       <div class="d-inline-block align-middle">
                                          <?php if($candidate->user_dp ==""){ ?>
                                             <img src="<?php echo e(asset('assets/images/profile.png')); ?>" alt="user image" class="img-radius img-40 align-top m-r-15">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Wamp64\www\leuke-app\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>